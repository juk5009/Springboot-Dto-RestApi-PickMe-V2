...
public class JwtProvider {
    ...
    private static final String SUBJECT = "pickme";
    private static final int EXP = 1000 * 60 * 60;
    public static final String TOKEN_PREFIX = "Bearer ";
    public static final String HEADER = "Authorization";
    private static final String SECRET = "pickme";
    ...
    public static String create(Company company) {
        String jwt = JWT.create()
                ...
                .withClaim("role", company.getRole())
                .sign(Algorithm.HMAC512(SECRET));
        return TOKEN_PREFIX + jwt;
    }

    public static DecodedJWT verify(String jwt) throws SignatureVerificationException, TokenExpiredException {
        DecodedJWT decodedJWT = JWT.require(Algorithm.HMAC512("pickme"))
                .build().verify(jwt);
        return decodedJWT;
    }
}
